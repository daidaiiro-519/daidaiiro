...
SLIDES = [
 ...
 dict(label='テーマの設計', title='幅のあるテーマから、取り組む課題を本人が決める。',
      ...
      body=table(['開発者向けの領域','PM・PL向けの領域'],[
          ...
          ['新しい参加者が仕事を始めやすくする','相談や知識共有が生まれやすくする']])+note('テーマを絞る問い：誰が、どんな場面で困るか。何が変われば役に立ったと判定できるか。'),
 ...
 dict(label='目指す成果',title='自分のスキルをAIで仕組化し、他の人にも届ける。',intro='知識・ノウハウ・判断の目安を言葉にし、他の人も使える形にする。',body=visuals.handoff()+note('目指す成果：業務の効率化や課題の改善に、他の人もその仕組みを使える。'),notes='自分が持つ知識や仕事の進め方を言語化し、AIで動く仕組みに組み込みます。エージェントに仕事を進める役割を与え、Skillsに手順や判断の目安を持たせることで、その知識を他の人も利用できる形にします。本人と同じ熟練を前提にせず、仕組みを通じて業務の効率化や課題改善に役立ててもらうことが目的です。AIの出力を確認する必要はあり、技能全体を完全に置き換えるという意味ではありません。説明や初回の支援があっても構いません。他者が使った結果と、どんな改善に役立ったかを確認します。',cls='ws-diagram'),
 ...
 dict(label='下期の進め方', title='半年間で、試作から他者の利用へ進める。',
      ...
      body='<div class="ws-phases"><svg class="ws-phase-path" viewBox="0 0 1112 240" role="img" aria-label="10・11月の試作から、12・1月の再確認を経て、2・3月の他者利用へ進む"><path d="M 355 107 h 21 m -6 -6 l 6 6 -6 6 M 736 107 h 21 m -6 -6 l 6 6 -6 6" fill="none" stroke="#747c6e" stroke-width="2"/></svg><div><p class="ws-date">10・11月</p><h3>学び、試作する</h3><p>概念教材を視聴する<br>課題を選び、小さく動かす</p></div><div class="ws-phase-hot"><p class="ws-date">12・1月</p><h3>見せて、絞り直す</h3><p>12月に中間成果を共有する<br>他者の反応で方向を再確認する</p></div><div><p class="ws-date">2・3月</p><h3>使ってもらい、残す</h3><p>別の人が試して改善する<br>3月に成果と学びを共有する</p></div></div>'+note('日程は提案。主催者指定の「10月開始・下期」を、上記の期間として計画している。'),
 ...
 dict(label='最終成果物発表・交流会',title='気軽に集まり、作った仕組みを見せ合う。',intro='コミュニケーション施策として、軽食を囲むオフライン交流会を開く。',body=diagram([('見せる','短いデモで取り組みを紹介'),('話す・試す','軽食を囲んで気軽に交流'),('つなげる','使いたい人へ仕組みを共有')],hot=1)+note('その場で試せないものは後日試用する。人気投票・表彰は交流を楽しむ企画として検討する。'),notes='最終回は参加者が集まるオフラインの交流会兼成果物発表会にします。軽食を囲み、短いデモを互いに紹介したり、作った工夫や困ったことを話したりできる、堅苦しくない場を目指します。会場、飲食費、日程は今後調整します。その場で試せない成果物は後日の試用につなげます。交流と他者利用のきっかけを作る場とし、人気投票は任意の企画案として残します。',cls=''),
 dict(label='効果測定の方法',title='他者に役立つ仕組みと、業務での活用の変化を確認する。',intro='事前・中間・終了時に同じ設問で回答し、成果物の試用記録も集める。',body=visuals.evaluation()+note('主KPI案：他者に役立つ仕組みを作れた参加者数／開始時の参加者数。詳細は付録へ。'),notes='主KPIは、自分の知識をAIで動く仕組みにし、他者が使用して役立ったと確認できた参加者の割合を提案します。開始時の参加者数を分母に固定し、未提出や未確認も明示します。個人目標の達成状況と、業務別のAI活用の変化を補助指標にします。アンケートは同じ人・同じ業務を比較し、回答人数を示します。能力の自己評価と実際の利用経験は合算しません。数値目標は事前調査と運営条件を見て開催前に決めます。',cls='ws-eval ws-diagram'),
...
SLIDES.extend([
 dict(label='付録｜KPI案',title='制作・業務活用・個人目標の3つで成果を報告する。',intro='指標と集計方法の提案。達成人数の目標値は、開始前に設定する。',cls='ws-form',body=table(['指標','数え方・確認方法'],[
 ['主KPI：他者に役立つ仕組み','他者が使って役立った仕組みを作れた参加者数／開始時の参加者数'],
 ['補助：業務別のAI活用','同じ人・同じ業務で、実務利用あり（2・3）の人数の変化'],
 ['補助：個人目標の達成','開始時に決めた達成条件と、終了時の結果・根拠を照合']])+note('人数と分母を併記。配布・試用・実務利用を区別し、人気投票は成果指標に含めない。'),notes='主KPIは人数単位で重複を除きます。他者の利用記録に用途・結果・役立った点が残ることを条件にし、デモの閲覧だけでは数えません。試用と実務利用の内訳を分けます。未提出・未確認は分母から外さず内訳を示します。共同制作では本人が担当した知識や手順の具体化を確認します。業務活用は前後とも担当・実施機会があり回答した人のみで比較し、職種の総合点や順位を作りません。'),
