...
SLIDES = [
 ...
 dict(label='下期の進め方', title='半年間で、作成から他の人の利用へ進める。',
      ...
      notes='毎週同じ時間に集合することは前提にしません。10月から翌3月までを提案期間とし、12月に中間共有、3月に最終共有を置きます。初期から試作に触れ、中間発表まで完成を待たないようにします。途中のテーマ変更も、試した結果に理由があれば認めます。休暇や繁忙期を踏まえ、実働20週を工数試算の仮定にしています。'),
...
PREMISE = dict(label='前提条件と未確定事項', title='開催条件は与件、それ以外は本日の了承後に確定する。', cls='ws-form',
  intro='開催前から決まっている条件と、今回の提案で未確定の事項を区別する。',
...
def build():
    ...
    notes=[f'# 部長向け発表原稿\n\n全{len(SLIDES)}枚。表紙1枚、本編14枚、付録{len(SLIDES)-15}枚。決定済みの条件と、今回の運営提案を分けて説明します。\n']
    for i,s in enumerate(SLIDES,1):
