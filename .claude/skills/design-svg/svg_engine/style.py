...
照らして検査する。範囲外の値を渡すレンダリングが破綻して気づくのではなく、
その場で例外にする。
"""
...
from .tokens import DEFAULT_THEME, PLAIN, ROLE_PREFIX, TOKEN_RANGES, Style  # noqa: F401
...
class IncompleteThemeError(ValueError):
    ...
    その鍵を参照する部品に当たった時点で組みかけのSVGを捨てることになる。
    """
