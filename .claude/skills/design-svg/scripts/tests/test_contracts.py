...
_ENGINE = pathlib.Path(__file__).resolve().parents[1] / "lib" / "svg_engine"
...
LAYER: dict[str, int] = {
    ...
    "shapes_interaction": 2, "shapes_quantity": 2, "shapes_table": 2,
    "shapes_text": 2, "shapes_titled": 2,
    # 3 合成 ── 全部を知ってよい唯一の場所
