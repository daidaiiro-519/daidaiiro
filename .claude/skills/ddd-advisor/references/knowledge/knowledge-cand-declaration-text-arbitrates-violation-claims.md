...
- 助言が「宣言に違反している」と述べたとき、何を確認すれば裁けるか
...
- 助言の中で型を取り違えた主張が1つ退けられても、同じ助言に含まれる他の指摘は別に扱う。否定されたのは主張の型であって、助言者の見立て全体ではない。
...
| 現物の観察 | 実装や成果物を観察して判定できること。宣言にも knowledge にも依存しない |
...
蔵書を処理する仕組みで、構成の宣言が「目録という概念は1ファイルに1つ」と述べている。開発者が、目録に属する値の型を別のフォルダへ移した。
...
この型で述べていれば、文言を根拠に退けることはできず、宣言を直す議論になった。適合の主張として述べたために、文言と照らして成立しなくなり、正しい見立てまで一緒に退けられた。
...
| アンチパターン | 問題点 |
|---|---|
| 宣言への異議を、適合の主張として述べる | 文言と照らすと成立しなくなるため、その裏にある正しい見立てまで一緒に退けられる |
