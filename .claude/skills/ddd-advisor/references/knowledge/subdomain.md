...
| 外部サービスの方が簡単で安いか | 現時点の費用の比較ではない。その業務を他社と同じやり方にしてしまってよいかを問う。安く済んでも差別化を捨てることになるなら「NO」である。 |
...
| 在庫の照会 ── 一般／貸出の申請 ── 一般／返却の記録 ── 一般／期限の通知 ── 一般 | 4つとも分類を書き添えてあるのは、分割の前後で分類が同じであることを見せるためである。分類が揃っていること自体が、この図の結論にあたる。 |
