...
**盤面の正本は Artifact 側にある。**ここに置いてあるのは、その時点の写しである。
続きを回すときは、先に Artifact を読んで、新しい版が出ていないかを確かめる。
...
`coding-essence/trial/language-go.html` は、論点5 を確かめるために書いた Go の規則16件の試作である。
Artifact 版は `https://claude.ai/artifact/U9mEBvpgYys8d12kVN6Mbq` にある。

**2つの盤面は互いを参照している。**`coding-essence` の論点6 は、`schema-three-tiers` の論点14
